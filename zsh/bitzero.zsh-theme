# bitzero.zsh-theme
# forked from: https://github.com/andyfleming/oh-my-zsh
...
eval prompt_color='$FG[075]'
eval sudo_prompt_color='$FG[196]'

if [ $UID -eq 0 ]; then eval ncolor='$FG[196]'; else eval ncolor='$FG[075]'; fi
...
then
	...
	RPROMPT='$sys_color%n@%m%{$reset_color%}%'
fi
